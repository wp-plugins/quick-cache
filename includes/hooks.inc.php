...
/**/
add_action ("qcache_cron_delete_cache_dir", "ws_plugin__qcache_delete_cache_dir");
add_action ("qcache_cron_garbage_collector", "ws_plugin__qcache_garbage_collector");
add_action ("qcache_cron_auto_cache_engine", "ws_plugin__qcache_auto_cache_engine");
