...
*/
add_action ("init", "c_ws_plugin__qcache_admin_css_js::menu_pages_js");
add_action ("init", "c_ws_plugin__qcache_admin_css_js::menu_pages_css");
/**/
add_filter ("status_header", "c_ws_plugin__qcache_status_headers::status", 10, 2);
/**/
add_filter ("gettext", "c_ws_plugin__qcache_translations::translation_mangler", 10, 3);
/**/
