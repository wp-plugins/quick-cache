...
add_action ("network_admin_menu", "ws_plugin__qcache_add_network_admin_options");
/**/
add_action ("admin_notices", "ws_plugin__qcache_admin_notices");
add_action ("user_admin_notices", "ws_plugin__qcache_admin_notices");
add_action ("network_admin_notices", "ws_plugin__qcache_admin_notices");
/**/
