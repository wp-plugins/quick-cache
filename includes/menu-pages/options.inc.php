...
echo '</div>' . "\n";
/**/
echo '<div class="ws-menu-page-group" title="Client-Side Caching">' . "\n";
/**/
...
echo '</div>' . "\n";
/**/
echo '<div class="ws-menu-page-group" title="Cache Expiration">' . "\n";
/**/
...
echo '</div>' . "\n";
/**/
echo '<div class="ws-menu-page-group" title="Cache Pruning">' . "\n";
/**/
...
echo '</div>' . "\n";
/**/
echo '<div class="ws-menu-page-group" title="No-Cache Patterns">' . "\n";
/**/
...
echo '</div>' . "\n";
/**/
echo '<div class="ws-menu-page-group" title="No-Cache User-Agents">' . "\n";
/**/
