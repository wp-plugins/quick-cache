...
echo '<td>' . "\n";
echo 'One per line please... ( these ARE case sensitive )<br />' . "\n";
echo '<textarea name="ws_plugin__qcache_dont_cache_these_refs" id="ws-plugin--qcache-dont-cache-these-refs" rows="3" wrap="off">' . format_to_edit ($GLOBALS["WS_PLUGIN__"]["qcache"]["o"]["dont_cache_these_refs"]) . '</textarea><br />' . "\n";
