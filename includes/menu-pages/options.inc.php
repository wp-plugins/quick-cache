...
echo '<h2><div>Developed by <a href="' . esc_attr (ws_plugin__qcache_parse_readme_value ("Plugin URI")) . '" target="_blank"><img src="' . esc_attr ($GLOBALS["WS_PLUGIN__"]["qcache"]["c"]["dir_url"]) . '/images/brand-light.png" alt="." /></a></div>Quick Cache Options</h2>' . "\n";
/**/
