...
*/
if (!function_exists ("ws_plugin__qcache_schedule_cache_dir_purge"))
	{
		function ws_plugin__qcache_schedule_cache_dir_purge ($qc_c_blog = FALSE, $leave_qc_l_locks = TRUE, $leave_qc_l_logs = TRUE)
			{
...
*/
if (!function_exists ("ws_plugin__qcache_purge_cache_dir"))
	{
		function ws_plugin__qcache_purge_cache_dir ($qc_c_blog = FALSE, $leave_qc_l_locks = TRUE, $leave_qc_l_logs = TRUE)
			{
