...
*/
if (($GLOBALS["WS_PLUGIN__"]["qcache"]["c"]["is_multisite"] = ((function_exists ("is_multisite") && is_multisite ()) || function_exists ("wpmu_current_site")))/**/
...
function ws_plugin__qcache_configure_options_and_their_defaults ($options = FALSE) /* Can also be used to merge options with defaults. */
	{
		...
		*/
		...
		/**/
		return apply_filters ("ws_plugin__qcache_options", $GLOBALS["WS_PLUGIN__"]["qcache"]["o"]);
	}
/**/
